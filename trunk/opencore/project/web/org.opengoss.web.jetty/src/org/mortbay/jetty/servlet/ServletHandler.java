...
import org.opengoss.web.internal.jetty.WebPluginHandler;
import org.opengoss.web.internal.jetty.DefaultDispatcher;
...
public class ServletHandler extends AbstractHandler
{
    ...
    /* ------------------------------------------------------------ */
    private WebPluginHandler _contextHandler;
    ...
    protected synchronized void doStart()
        throws Exception
    {
        _servletContext=WebPluginHandler.getCurrentContext();
        _contextHandler=_servletContext==null?null:((WebPluginServletContext)_servletContext).getContextHandler();
    ...
    public RequestDispatcher getRequestDispatcher(String uriInContext)
    {
        ...
        try
        {
            ...
            return new DefaultDispatcher(_contextHandler, uri, pathInContext, query);
        }
        catch(Exception e)
        {
            Log.ignore(e);
