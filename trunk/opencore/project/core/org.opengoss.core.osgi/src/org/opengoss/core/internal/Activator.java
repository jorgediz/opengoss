...
public class Activator implements BundleActivator {
	...
	ServiceRegistration asrRegistration;

	ServiceRegistration aerRegistration;
	...
	private void startConsole(BundleContext context) throws Exception {
		console = new Console();
	...
	private void stopConsole(BundleContext context) throws Exception {
		if(console != null) {
