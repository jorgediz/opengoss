 ...
 * <ul>
 * 	<li>Parse "META-INF/OPENCORE.XML" </li>
...
public abstract class PluginActivator implements BundleActivator {
	...
	static final String OPENCORE_XML = "META-INF/OPENCORE.XML";

	protected IPluginContext pluginContext = null;

	public void start(BundleContext context) throws Exception {
		//Parse the xml configuration file
		URL xml = context.getBundle().getEntry(OPENCORE_XML);
		if(xml == null) {
			log.error("No OPENCORE.XML found!");
			return;
		}
