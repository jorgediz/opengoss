...
public class TagLibConfiguration implements Configuration
{
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see org.mortbay.jetty.servlet.WebPluginContext.Configuration#configureDefaults()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see org.mortbay.jetty.servlet.WebPluginContext.Configuration#configureWebApp()
     */
            ...
            _context.getBaseResource().exists())
        {
            ...
            while(iter.hasNext())
            {
                ...
                if (location!=null && location.toLowerCase().endsWith(".tld"))
                {
                    ...
                    Resource l= null;//TODO: N_context.getBaseResource().addPath(location);
                    tlds.add(l);
                }
            }
        }
